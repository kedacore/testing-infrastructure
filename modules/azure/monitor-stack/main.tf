...
locals {
  ...
  azure_monitor_workspace_id   = azurerm_resource_group_template_deployment.azure_monitor_workspace.output_content != "{}" ? jsondecode(azurerm_resource_group_template_deployment.azure_monitor_workspace.output_content).workspace_id.value : ""
}
